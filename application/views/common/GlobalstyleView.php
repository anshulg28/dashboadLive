...
<link rel="icon" type="image/x-icon" sizes="76x76" href="<?php echo MOBILE_URL;?>asset/images/doolally-app-icon.png"/>
<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="<?php echo MOBILE_URL;?>asset/images/doolally-app-icon-apple.png"/>
<!--not tho change css-->
