...
<head>
	<meta charset="utf-8">
	<title>Work Area :: Doolally</title>
    ...
    <main class="workArea">
        <div class="container">
            <div class="row">
                <div class="col-sm-9 col-xs-8">
                    <a class="btn btn-primary" href="<?php echo base_url().'maintenance/addWorkArea';?>">
        ...
        <div class="container table-responsive">
            <table id="main-mugclub-table" class="table table-hover table-bordered table-striped">
                ...
                <?php
                if(isset($workAreas) && myIsArray($workAreas))
                {
                    ?>
                    <tbody>
                    <?php
                            ...
                            <td>
                                <?php
                                    ...
                                    else
                                    {
                                        echo 'Active';
                                        ?>
                                        &nbsp;<a href="<?php echo base_url();?>maintenance/editWorkArea/<?php echo $row['areaId'];?>">
